...
_KNOWN_METRICS: dict[str, str] = {
    ...
    "lợi nhuận gộp về bán hàng và cung cấp dịch vụ": "lợi nhuận gộp về bán hàng và cung cấp dịch vụ",
    "lợi nhuận gộp":                            "lợi nhuận gộp",
    "lợi nhuận thuần từ hoạt động kinh doanh":  "lợi nhuận thuần từ hoạt động kinh doanh",
    "lợi nhuận trước thuế thu nhập doanh nghiệp": "lợi nhuận trước thuế thu nhập doanh nghiệp",
    "lợi nhuận trước thuế":                     "lợi nhuận trước thuế",
    "lợi nhuận sau thuế thu nhập doanh nghiệp": "lợi nhuận sau thuế thu nhập doanh nghiệp",
    ...
    "chi phí dự phòng":                         "chi phí dự phòng",
    "dự phòng rủi ro":                          "chi phí dự phòng",
    "lãi thuần từ hoạt động dịch vụ":          "lãi thuần từ hoạt động dịch vụ",
    "thu nhập từ dịch vụ":                     "lãi thuần từ hoạt động dịch vụ",
    "cam kết cho thuê hoạt động":               "cam kết cho thuê hoạt động",
    "cam kết thuê hoạt động":                   "cam kết cho thuê hoạt động",
    "thuê hoạt động":                           "cam kết cho thuê hoạt động",
    ...
    "tiền gửi tại các tctd khác":              "tiền gửi tại các tctd khác",
    "tiền gửi tại tổ chức tín dụng":           "tiền gửi tại các tctd khác",
    ...
    "vay và nợ thuê tài chính ngắn hạn":        "vay và nợ thuê tài chính ngắn hạn",
    "vay ngắn hạn":                             "vay ngắn hạn",
    "vay và nợ thuê tài chính dài hạn":         "vay và nợ thuê tài chính dài hạn",
    ...
    "lợi nhuận sau thuế chưa phân phối":        "lợi nhuận sau thuế chưa phân phối",
    "lợi nhuận chưa phân phối":                 "lợi nhuận sau thuế chưa phân phối",
    "quỹ khen thưởng, phúc lợi":               "quỹ khen thưởng, phúc lợi",
    "quỹ khen thưởng phúc lợi":                "quỹ khen thưởng, phúc lợi",
    "tỷ lệ quyền biểu quyết":                  "tỷ lệ quyền biểu quyết",
    "tỷ lệ biểu quyết":                        "tỷ lệ quyền biểu quyết",
    # ── Lưu chuyển tiền tệ ─────────────────────────────────────────────────
    ...
    "lưu chuyển tiền thuần từ hoạt động tài chính":   "lưu chuyển tiền thuần từ hoạt động tài chính",
