...
_COMPANY_NAME_TO_TICKER: dict[str, str] = {
    ...
    "tập đoàn ceo":                 "CEO",
    "sonadezi":                     "SNZ",
    "phát triển đô thị và kcn cao su": "VRG",
    "khang điền":                   "KDH",
    "hà đô":                        "HDG",
    "tập đoàn hà đô":               "HDG",
    "hòa bình":                     "HBC",
    ...
    "tập đoàn hóa chất":            "CSV",
    "cao su việt nam":              "GVR",
    "tập đoàn công nghiệp cao su":  "GVR",

    # Hàng tiêu dùng, Bán lẻ, Nông nghiệp, Thực phẩm
    "vinamilk":                     "VNM",
    "sữa việt nam":                 "VNM",
